...
# #69.79
# print ('F1 score:', f1_score(y_test, y_pred,average='weighted'))#74.04
# print ('Recall:', recall_score(y_test, y_pred,average='weighted'))#74.01
# print ('Precision:', precision_score(y_test, y_pred, average='weighted'))#74.70
...
# print("mcc", matthews_corrcoef(y_test, y_pred))
# #67.75
# print ('F1 score:', f1_score(y_test, y_pred,average='weighted'))#72.41
# print ('Recall:', recall_score(y_test, y_pred,average='weighted'))#72.31
# print ('Precision:', precision_score(y_test, y_pred, average='weighted'))#72.88
...
# print("mcc", matthews_corrcoef(y_test, y_pred))
# #68.98
# print ('F1 score:', f1_score(y_test, y_pred,average='weighted'))#73.47
# print ('Recall:', recall_score(y_test, y_pred,average='weighted'))#73.26
# print ('Precision:', precision_score(y_test, y_pred, average='weighted'))#74.57
...
# print("mcc", matthews_corrcoef(y_test, y_pred))
# #69.59
# print ('F1 score:', f1_score(y_test, y_pred,average='weighted'))#73.95
# print ('Recall:', recall_score(y_test, y_pred,average='weighted'))#73.87
# print ('Precision:', precision_score(y_test, y_pred, average='weighted'))#74.44
...
# print(r)
 ...
 #----------------SVM(polynomial)--------------
# from sklearn import svm
# clfpol = svm.SVC(C=0.001, decision_function_shape='ovr', degree=3, gamma= 100, kernel='poly',
#     max_iter=-1, probability=False, random_state=None, shrinking=True,
#     tol=0.001, verbose=False)
...
# print("SVM Polynomial:",metrics.accuracy_score(y_test, y_pred))#67.27
# print("mcc", matthews_corrcoef(y_test, y_pred))
# #63.03
# print ('F1 score:', f1_score(y_test, y_pred,average='weighted'))#68.89
# print ('Recall:', recall_score(y_test, y_pred,average='weighted'))#67.27
# print ('Precision:', precision_score(y_test, y_pred, average='weighted'))#74.55
...
# print("mcc", matthews_corrcoef(y_test, y_pred))
# #67.40
# print ('F1 score:', f1_score(y_test, y_pred,average='weighted'))#71.62
# print ('Recall:', recall_score(y_test, y_pred,average='weighted'))#71.97
# print ('Precision:', precision_score(y_test, y_pred, average='weighted'))#71.97
...
# print("mcc", matthews_corrcoef(y_test, y_pred))
# #63.40
# print ('F1 score:', f1_score(y_test, y_pred,average='weighted'))#67.07
# print ('Recall:', recall_score(y_test, y_pred,average='weighted'))#68.43
# print ('Precision:', precision_score(y_test, y_pred, average='weighted'))#67.36
...
#
# gnb= GaussianNB()
# print((cross_val_score(gnb,X_train, y_train, cv=10)))#54.46
...
# print("mcc", matthews_corrcoef(y_test, y_pred))
# #49.03
# print ('F1 score:', f1_score(y_test, y_pred,average='weighted'))#54.16
# print ('Recall:', recall_score(y_test, y_pred,average='weighted'))#56.12
# print ('Precision:', precision_score(y_test, y_pred, average='weighted'))#53.91
...
# print("mcc", matthews_corrcoef(y_test, y_pred))
# #58.74
# print ('F1 score:', f1_score(y_test, y_pred,average='weighted'))#64.94
# print ('Recall:', recall_score(y_test, y_pred,average='weighted'))#64.55
# print ('Precision:', precision_score(y_test, y_pred, average='weighted'))#65.80
